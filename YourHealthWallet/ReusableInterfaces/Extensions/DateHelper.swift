...
public extension Date {
    ...
    */
    ...
    public func plusHoursMinutesSeconds(hours h: UInt,minutes m: UInt,seconds s: UInt) -> Date {
        return self.addComponentsToDate(seconds: Int(s), minutes: Int(m), hours: Int(h), days: 0, weeks: 0, months: 0, years: 0)
    }
