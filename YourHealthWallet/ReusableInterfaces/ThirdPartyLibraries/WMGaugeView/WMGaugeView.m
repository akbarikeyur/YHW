...
- (void)initialize;
{
    ...
    _needleColor = RGB(68, 84, 105);
    _needleScrewColor = RGB(217, 217, 217);
    
    _scaleFont = nil;
    
    _unitOfMeasurementVerticalOffset = 0.6;
    _unitOfMeasurementColor = [UIColor whiteColor];
    _unitOfMeasurementFont = [UIFont fontWithName:@"Avenir-Heavy" size:0.05];
    _unitOfMeasurement = @"";
...
- (void)drawNeedle
{
    switch (_needleStyle)
    {
        case WMGaugeViewNeedleStyle3D:
        {
            ...
            rightNeedleLayer.fillColor = _needleColor.CGColor;
        ...
        case WMGaugeViewNeedleStyleFlatThin:
        {
            ...
            needleLayer.strokeColor = _needleColor.CGColor;
...
- (void)drawNeedleScrew
{
    switch (_needleScrewStyle)
    {
        case WMGaugeViewNeedleScrewStyleGradient:
        {
            ...
            screwLayer.strokeColor = _needleScrewColor.CGColor;
