//
//  MedicationDateCollectionView.swift
//  YourHealthWallet
//
...
class MedicationDateCollectionView: CollectionView, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    
    private var MedicationDateCollectionViewCellIdentifier = "MedicationDateCollectionViewCellIdentifier"
    ...
    func initializeMedicationsDateCollectionView() {
        ...
        self.register(UINib(nibName: "MedicationDateCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: MedicationDateCollectionViewCellIdentifier)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: MedicationDateCollectionViewCellIdentifier, for: indexPath) as! MedicationDateCollectionViewCell
